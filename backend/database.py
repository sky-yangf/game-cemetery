...
# TursoClient: created at module import (eager init, no lazy)
_turso_client = TursoClient() if IS_TURSO else None

def ensure_tables_once():
    if IS_TURSO and _turso_client is not None:
        _turso_client.ensure_tables()
